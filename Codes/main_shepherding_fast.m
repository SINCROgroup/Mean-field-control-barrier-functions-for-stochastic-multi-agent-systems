...
for kk = 1:50
    ...
    % Sample C dangerous disk centers with uniform distribution.
    ...
    for i = 1 : length(t)
        ...
        [Vl, Hl(i)] = compute_safe_velocity_Rk_grid(Xl, Xext, Yext, mu, constraint_bound, ...
            epsilon_Rk_L, 0, U, Phi_ext, Phi_x_ext, Phi_y_ext, Nl, 0, alpha_val);
        ...
        [Vf, Hf(i)] = compute_safe_velocity_Rk_grid(Xf, Xext, Yext,  mu, constraint_bound, ...
            epsilon_Rk_F, D, Vlf, Phi_ext, Phi_x_ext, Phi_y_ext, Nf, lap_Phi_ext, alpha_val);
